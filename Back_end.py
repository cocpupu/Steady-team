...
#naca 4,5
        ...
        for i in range(0,28):
            sdf_array.append(np.array(d1))#Nối các hàng khác vào cuối khung này, trả về một đối tượng mới. Các cột không có trong khung này được thêm vào dưới dạng cột mới. 
        for i in range(28,56):
